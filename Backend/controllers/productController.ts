...
export const getProductByStoneLotus = async function (req: Request, res: Response) {
    try {
...
export const getProductByHangingTree = async function (req: Request, res: Response) {
    try {
